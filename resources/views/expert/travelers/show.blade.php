<x-app-layout>
    ...
    <div class="py-12 bg-sand dark:bg-sand-900 min-h-screen">
        <div class="mx-auto max-w-4xl sm:px-6 lg:px-8 space-y-12">
                    ...
                    <div class="flex flex-col sm:flex-row gap-10 items-start sm:items-center">
                        ...
                        <div class="space-y-4 flex-1">
                            ...
                            @if($traveler->user->phone_number)
                                <p class="text-md text-ink-700 dark:text-sand-200 flex items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-copper"
                                         fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            {{-- Itineraries (Optional Section, if you want it) --}}
            @if(isset($traveler->itineraries) && $traveler->itineraries->count())
                <div class="bg-white dark:bg-sand-800 border border-sand-200 dark:border-ink-700
                            rounded-3xl shadow-soft transition-all duration-300 p-10">
