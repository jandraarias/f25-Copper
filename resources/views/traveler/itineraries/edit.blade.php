                    ...
                    <form method="POST" action="{{ route('traveler.itineraries.update', $itinerary) }}">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    class="w-full border border-sand-200 dark:border-ink-700 rounded-xl shadow-sm
                                           focus:ring-copper focus:border-copper focus:shadow-glow
                                           transition-all duration-200 px-4 py-2.5 dark:bg-sand-900"
                                    placeholder="A week exploring Italy’s countryside and cities...">{{ old('description', $itinerary->description) }}</textarea>
                        ...
                        <div class="mt-10 flex items-center gap-4 justify-end">
                            ...
                            <button type="submit"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 transition-transform duration-200 group-hover:rotate-6"
                                     fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div class="bg-white dark:bg-sand-800 border border-sand-200 dark:border-ink-700 rounded-3xl shadow-soft
                ...
                <div class="p-8 text-ink-900 dark:text-ink-100">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-lg font-semibold text-ink-900 dark:text-ink-100">Items</h3>
                        <button type="button" @click="showNewItem = !showNewItem"
                                class="px-4 py-2.5 rounded-full bg-gradient-copper text-white font-medium shadow-soft
                                       hover:shadow-glow hover:scale-[1.03] transition-all duration-200 ease-out">
                    ...
                    <div x-show="showNewItem" x-cloak class="mb-8">
                        <form method="POST" action="{{ route('traveler.itineraries.items.store', $itinerary) }}">
                            @csrf
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {{-- (same field styling as itinerary form) --}}
